...
const translations = {
  vi: {
    ...
    'nav.compare': 'So sánh',
    'nav.logger': 'Nhật ký tập',

    // ── Workout Logger ──
    'logger.title': 'Nhật ký<br><strong>Tập luyện</strong>',
    'logger.subtitle': 'Ghi lại các hiệp tập, mức tạ và số lần lặp. Theo dõi khối lượng tập và kỷ lục cá nhân.',
    'logger.total_workouts': 'Tổng buổi tập',
    'logger.total_volume': 'Tổng khối lượng',
    'logger.total_sets': 'Tổng số hiệp',
    'logger.this_week': 'Tuần này',
    'logger.active_session': 'Buổi tập đang diễn ra',
    'logger.active_hint': 'Bản nháp tự động lưu trên trình duyệt.',
    'logger.routine_name': 'Tên buổi tập',
    'logger.date_time': 'Ngày & Giờ',
    'logger.notes': 'Ghi chú buổi tập',
    'logger.finish_btn': '✓ Hoàn thành buổi tập',
    'logger.discard_btn': '✕ Hủy buổi tập',
    'logger.history_title': 'Lịch sử tập luyện',
    'logger.search_history_placeholder': 'Tìm lịch sử theo tên, nhóm cơ hoặc ghi chú…',
    'logger.clear_all': 'Xóa toàn bộ lịch sử',
    'logger.date': 'Ngày',
    'logger.set': 'Hiệp',
    'logger.weight': 'Mức tạ (kg)',
    'logger.reps': 'Số lần (reps)',
    'logger.rpe': 'RPE (1-10)',
    'logger.volume': 'Khối lượng',
    'logger.est_1rm': 'Ước tính 1RM',

    // ── Exercise detail log widget ──
    'detail.log_this_exercise': 'Ghi nhật ký bài này',
    'detail.log_widget_title': 'Lịch sử tập & Ghi nhanh hiệp',
    'detail.log_widget_hint': 'Ghi lại các hiệp tập cho bài này và theo dõi kỷ lục cá nhân (PR).',
    'detail.log_open_full': 'Mở trang Nhật ký 📋',
    'detail.pr_badge': '🏆 Kỷ lục cá nhân (PR)',
    'detail.log_add_set': '+ Ghi hiệp',
